...
<head>
    ...
    <title>Daftar Talents Hero</title>
...
<body>
            ...
            <div class="collapse navbar-collapse justify-content-end me-5" id="navbarSupportedContent">
                <nav>
                    <div class="nav d-block d-lg-flex nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <a class="nav-link active" id="talents-tab" href="user-talents.php" role="tab" aria-controls="talents" aria-selected="true">Talents</a>
    ...
    <div class="container my-4">
        <h2 class="mb-4 text-center">Daftar Talents Hero</h2>
        <div class="row">
            <?php
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<thead>";
                    echo "<tr>";
                    echo "<th scope='col'>Level 10</th>";
                    echo "<th scope='col'>Level 15</th>";
                    echo "<th scope='col'>Level 20</th>";
                    echo "<th scope='col'>Level 25</th>";
                    echo "</tr>";
                    echo "</thead>";
                    echo "<tbody>";
                    echo "<tr>";
