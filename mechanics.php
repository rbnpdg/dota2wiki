...
<div class="container my-4">
    <h2 class="mb-4 text-center">Daftar Mechanics</h2>
    <div class="d-flex justify-content-end mb-3">
        <a href="mechanics-add.php" class="btn btn-primary">Tambah Data</a>
    </div>
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                        <div class='btn-group'>
                            ...
                            <a href='mechanics-delete.php?id=".$row["id_mechanics"]."&gambar=".$row["gambar"]."' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin akan menghapus mekanik ini?\")'>Delete</a>
                        </div>
                        </td>";
                    echo "</tr>";
