        ...
        <div class="collapse navbar-collapse justify-content-end me-5" id="navbarSupportedContent">
            <nav>
                <div class="nav d-block d-lg-flex nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-link active" id="creep-tab" href="creep.php" role="tab" aria-controls="creep" aria-selected="true">Creep</a>   
...
<div class="container my-4">
    ...
    <div class="d-flex justify-content-end mb-3">
        <a href="creep-add.php" class="btn btn-primary">Tambah Data</a>
    </div>
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                        <div class='btn-group'>
                            ...
                            <a href='creep-delete.php?id=".$row["id_creep"]."&gambar=".$row["gambar"]."' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin akan menghapus creep ini?\")'>Delete</a>
                        </div>
                        </td>";
                    echo "</tr>";
