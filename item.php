                ...
                <div class="card-header py-3">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <h5 class="m-0 font-weight-bold text-primary">
                            <b style="font-size: 30px; color: #A20800; font-weight: 700;">Daftar Item</b>
                        </h5>
                        <a href="item-add.php" class="d-none d-sm-inline-block btn btn-sm btn-primary rounded-pill shadow-sm d-flex align-items-center" style="font-size: 15px; background-color: #A20800; border-color: #A20800;">
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>
                                        <div class='btn-group'>
                                            <a href='item-update.php?id=".$row["id_item"]."' class='btn btn-warning btn-sm me-2'>Edit</a>
                                            <a href='item-delete.php?id=".$row["id_item"]."' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin akan menghapus Item ini??\")'>Delete</a>
                                        </div>
                                        </td>";
                                echo "</tr>";
